...
4. Start the server:
   ...
   uv run python -m songgeneration_mcp.server

   # HTTP mode (for web dashboard)
   uv run uvicorn songgeneration_mcp.server:app --port 10885
   ```
5. Open `http://localhost:10885` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/songgeneration-mcp/issues) |
