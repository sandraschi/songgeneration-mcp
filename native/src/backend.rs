...
const BACKEND_NAME: &str = "songgeneration-mcp-backend.exe";
const BACKEND_PORT: u16 = 10885;
const BACKEND_TAG: &str = "songgeneration-mcp-backend-x86_64-pc-windows-msvc.exe";
const ENV_PORT: &str = "SONGGENERATION_MCP_PORT";
const ENV_HOST: &str = "SONGGENERATION_MCP_HOST";
const ENV_TAURI: &str = "SONGGENERATION_MCP_TAURI";
